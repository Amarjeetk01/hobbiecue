    ...
    <section className={styles.testimonials}>
      <div className={styles.rectangleParent}>
        ...
        <div className={styles.inAFast}>
          ...
          Websites like hobbycue.com are a great service that helps me connect
          with other dancers, exchange ideas, and find quality products and
          services recommended by the hobbycue community. It provides a platform
          to discuss, gain visibility, and explore various hobbies and
          activities in my city, all under one roof. Highly recommended!
        </div>
        ...
        <div className={styles.ellipseGroup}>
          ...
          <div className={styles.audioTrack}>
            ...
            <div className={styles.audioTrackInnerImgGroup}>
            <img
