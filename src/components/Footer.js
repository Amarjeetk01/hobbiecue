      ...
      <div className={styles.groupWrapper}>
        <div className={styles.group}>
          <div className={styles.groupParent}>
            ...
            <div className={styles.postaQuery}>
              ...
              <div className={styles.otherQueries}>
                ...
                />
                <img
                  className={styles.otherQueriesItem}
                  loading="eager"
                  alt=""
                  src="/group-61.svg"
                />
                ...
                />
                <img
                  className={styles.otherQueriesChild1}
                  loading="eager"
                  alt=""
                  src="/group-59.svg"
                />
                <img
                  className={styles.otherQueriesChild2}
                  loading="eager"
                  alt=""
                  src="/group-58.svg"
                />
                <img
                  className={styles.otherQueriesChild3}
                  loading="eager"
                  alt=""
                  src="/group-57.svg"
                />
                <img
                  className={styles.otherQueriesChild4}
                  alt=""
                  src="/group-56.svg"
                />
              </div>
          ...
          <div className={styles.footerFrame}>
            ...
            <div className={styles.addListingFrame}>
